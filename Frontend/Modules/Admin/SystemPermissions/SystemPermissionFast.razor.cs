...
public partial class SystemPermissionFast : ComponentBase
{
    [Inject] private SystemPermissionService SystemPermissionService { get; set; } = null!;
    [Inject] private NotificationService NotificationService { get; set; } = null!;
    
    [Parameter] public EventCallback<SystemPermissionEntity> OnEntityCreated { get; set; }
        ...
        try
        {
            ...
            if (response.Success && response.Data != null)
            {
                NotificationService.Notify(new NotificationMessage
                {
                    ...
                    Summary = "¡Éxito!",
                    Detail = "SystemPermission creado exitosamente",
                    Duration = 4000
                });
