    ...
    protected override async Task OnInitializedAsync()
    {
        if (isEditMode && Id.HasValue)
        {
            ...
            if (Navigation.Uri.Contains("created=true"))
            {
                ...
                Navigation.NavigateTo($"/catalogo/marca/formulario/{Id}", replace: true);
            }
        }
        else
        {
    ...
    private async Task LoadEntity()
    {
        try
        {
            ...
            else
            {
                ...
                Navigation.NavigateTo("/catalogo/marca/list");
            }
        }
        catch (Exception ex)
        {
    ...
    private async Task SaveForm()
    {
        try
        {
            ...
            else
            {
                ...
                {
                    entity = response.Data;
                    Navigation.NavigateTo($"/catalogo/marca/formulario/{entity.Id}?created=true");
                }
                else
                {
                    NotificationService.Notify(new NotificationMessage
