...
{
    /// <summary>
    /// CustomDataFilter component.
    /// </summary>
    /// <typeparam name="TItem">The type of the item.</typeparam>
#if NET6_0_OR_GREATER
    [CascadingTypeParameter(nameof(TItem))]
#endif
    public partial class CustomDataFilter<TItem> : CustomRadzenComponent
    {
        /// <inheritdoc />
        ...
        public IList<CustomDataFilterProperty<TItem>> PropertiesCollection
        {
            get
            {
                return properties;
        ...
        internal List<CustomDataFilterProperty<TItem>> properties = new List<CustomDataFilterProperty<TItem>>();
